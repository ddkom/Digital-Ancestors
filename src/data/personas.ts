...
export const PERSONAS: PersonaCard[] = [
  {
    ...
    subtitle: "AI Hater",
    stanceText: "OPT-OUT",
    image: `${import.meta.env.BASE_URL}personas/guardian.jpeg`,
  ...
  },
  {
    ...
    image: `${import.meta.env.BASE_URL}personas/steward.png`,
  ...
  },
  {
    ...
    image: `${import.meta.env.BASE_URL}personas/trailblazer.jpeg`,
