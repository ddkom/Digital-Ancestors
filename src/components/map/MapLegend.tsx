...
const CHARACTER_HASHES = ["guardian", "scribe", "weaver", "trailblazer"] as const;

export function MapLegend() {
  const legendItems = [
    { label: copy.map.legend.protect, hash: CHARACTER_HASHES[0] },
    { label: copy.map.legend.admin, hash: CHARACTER_HASHES[1] },
    { label: copy.map.legend.tend, hash: CHARACTER_HASHES[2] },
    { label: copy.map.legend.create, hash: CHARACTER_HASHES[3] },
  ];
